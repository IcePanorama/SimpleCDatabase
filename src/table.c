...
void 
internal_node_insert(Table* table, uint32_t parent_page_num, uint32_t child_page_num)
{
    /*
...
void 
internal_node_split_and_insert(Table* table, uint32_t parent_page_num, uint32_t child_page_num)
{
    ...
    *internal_node_right_child(old_node) = INVALID_PAGE_NUM;
     ...
     */
    *internal_node_right_child(old_node) = *internal_node_child(old_node, 
            *old_num_keys - 1);
    (*old_num_keys)--;
    ...
    uint32_t destination_page_num = child_max < max_after_split ? old_page_num 
        : new_page_num;
